...
# model = load_model('Models/11_11_train_test_20_20_epoch_25_batch_8.h5')
model = load_model('Models/17_11_offlineTraining_hadoop_pySpark_epoch_20.h5')
...
#
# df[['meantemp_diff', 'humidity_diff', 'wind_speed_diff']] = df[['meantemp', 'humidity', 'wind_speed']].diff().fillna(1)
